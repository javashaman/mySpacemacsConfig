  ...
  (setq-default
   ...
   '(
     ...
     (typescript :variables
                 ...
                 ;; ^^ can be: 'tide (default), 'prettier, 'typescript-formatter
...
`dotspacemacs/user-config' first."
  ...
  ;; MY CUSTOM
  ;; mostly from here: https://dev.to/viglioni/how-i-set-up-my-emacs-for-typescript-3eeh
  (my-setup-indent 2)
...
(defun my-setup-indent (n)
  (setq-default indent-tabs-mode n)
